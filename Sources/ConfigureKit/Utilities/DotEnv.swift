// This code was sourced from: https://github.com/vapor/vapor/
...
public struct DotEnvFile {
    ...
    public static func load(
        ...
        DotEnvFile.load(path: ".env.\(environment.name)", eventLoopGroup: eventLoopGroup)
        DotEnvFile.load(path: ".env", eventLoopGroup: eventLoopGroup)
    }
